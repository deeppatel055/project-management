...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      <Route
        path="/projects/add"
        element={<AddProjectForm onClose={() => window.history.back()} />}
      />
      <Route
        path="/projects/:id/edit"
        element={<EditProjectForm onClose={() => window.history.back()} />}
      />
      <Route path="/projects/:id" element={<ProjectDetails />} />

      {/* Task routes */}
      <Route path="/projects/:project_id/tasks/:task_id" element={<TaskDetailsPage />} />
      <Route
        path="/projects/:projectId/add-task"
        element={<AddTaskForm onClose={() => window.history.back()} />}
      />
      <Route
        path="/projects/:project_id/tasks/:task_id/edit"
        element={<EditTaskDetails isEdit />}
      />
